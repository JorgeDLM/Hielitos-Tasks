...
function ProductoPublicarSimilarID(props) {
    ...
    const [subidoAmazon, setSubidoAmazon] = useState(false)
    const [subidoFacebook, setSubidoFacebook] = useState(false)
...
// Setear compuesto
    ...
    const imagenInvalida = imagenGrande === "https://static.vecteezy.com/system/resources/thumbnails/000/350/939/small/Electronic_Devices__2828_29.jpg" || !imagenMediana || !imagenThumbnail
